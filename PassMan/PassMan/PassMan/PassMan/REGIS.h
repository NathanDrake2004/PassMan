...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->picmain->Location = System::Drawing::Point(129, 6);
			this->picmain->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->picmain->Name = L"picmain";
			this->picmain->Size = System::Drawing::Size(156, 150);
			this->picmain->TabIndex = 0;
			this->picmain->TabStop = false;
			this->picmain->Click += gcnew System::EventHandler(this, &REGIS::picmain_Click);
			// 
			// picuser
			// 
			...
			this->picuser->Location = System::Drawing::Point(26, 174);
			this->picuser->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->picuser->Name = L"picuser";
			this->picuser->Size = System::Drawing::Size(41, 42);
			...
			this->User->Location = System::Drawing::Point(82, 178);
			this->User->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->User->Name = L"User";
			this->User->Size = System::Drawing::Size(298, 34);
			...
			this->panel1->Location = System::Drawing::Point(26, 226);
			this->panel1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(375, 2);
			this->panel1->TabIndex = 3;
			// 
			// panel2
			// 
			this->panel2->BackColor = System::Drawing::SystemColors::ButtonHighlight;
			this->panel2->Location = System::Drawing::Point(26, 298);
			this->panel2->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(375, 2);
			...
			this->pass->Size = System::Drawing::Size(199, 34);
			...
			this->picpass->Location = System::Drawing::Point(26, 246);
			this->picpass->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->picpass->Name = L"picpass";
			this->picpass->Size = System::Drawing::Size(41, 42);
			...
			this->close->Location = System::Drawing::Point(374, 18);
			this->close->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->close->Name = L"close";
			this->close->Size = System::Drawing::Size(41, 42);
			...
			this->sign->Font = (gcnew System::Drawing::Font(L"Modern No. 20", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->sign->Location = System::Drawing::Point(26, 497);
			this->sign->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->sign->Name = L"sign";
			this->sign->Size = System::Drawing::Size(375, 60);
			...
			this->panel3->Location = System::Drawing::Point(24, 454);
			this->panel3->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->panel3->Name = L"panel3";
			this->panel3->Size = System::Drawing::Size(375, 2);
			...
			this->pictureBox1->Location = System::Drawing::Point(24, 402);
			this->pictureBox1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(41, 42);
			...
			this->panel4->Location = System::Drawing::Point(24, 371);
			this->panel4->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->panel4->Name = L"panel4";
			this->panel4->Size = System::Drawing::Size(375, 2);
			...
			this->email->Location = System::Drawing::Point(81, 325);
			this->email->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->email->Name = L"email";
			this->email->Size = System::Drawing::Size(298, 34);
			...
			this->pictureBox2->Location = System::Drawing::Point(24, 318);
			this->pictureBox2->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(41, 42);
			...
			this->DOB->Location = System::Drawing::Point(200, 402);
			this->DOB->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			...
			this->DOB->Size = System::Drawing::Size(169, 41);
			...
			this->label1->Location = System::Drawing::Point(78, 408);
			...
			this->passs->Location = System::Drawing::Point(82, 251);
			this->passs->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->passs->Name = L"passs";
			this->passs->Size = System::Drawing::Size(298, 34);
			...
			this->ClientSize = System::Drawing::Size(426, 614);
...
#pragma endregion
	private: System::Void picmain_Click(System::Object^ sender, System::EventArgs^ e) {
	}
};
}
